public class Constants 
{
    ...
    public const string PREFAB_CELL_BACKGROUND_POOL = "cellBackground";

    public const string PREFAB_NORMAL_TYPE_ONE_POOL = "itemNormal01";

    public const string PREFAB_NORMAL_TYPE_TWO_POOL = "itemNormal02";

    public const string PREFAB_NORMAL_TYPE_THREE_POOL = "itemNormal03";

    public const string PREFAB_NORMAL_TYPE_FOUR_POOL = "itemNormal04";

    public const string PREFAB_NORMAL_TYPE_FIVE_POOL = "itemNormal05";

    public const string PREFAB_NORMAL_TYPE_SIX_POOL = "itemNormal06";

    public const string PREFAB_NORMAL_TYPE_SEVEN_POOL = "itemNormal07";

    public const string PREFAB_BONUS_HORIZONTAL_POOL = "itemBonusHorizontal";

    public const string PREFAB_BONUS_VERTICAL_POOL = "itemBonusVertical";

    public const string PREFAB_BONUS_BOMB_POOL = "itemBonusBomb";
}
